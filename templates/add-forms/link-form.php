<?php
$validation_post_link = (!empty($errors['post-link'])) ? "form__input-section--error" : "";
    ...
    <div class="form__text-inputs-wrapper">
        <div class="form__text-inputs">
            <div class="adding-post__textarea-wrapper form__input-wrapper">
                ...
                <div
                    class="form__input-section <?= $validation_post_link ?>">
                    ...
                    <div class="form__error-text">
                        ...
                        <p class="form__error-desc"><?= $error_post_link ?></p>
                    </div>
                </div>
            </div>
        </div>
