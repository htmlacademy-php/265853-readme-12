<?php
$validation_video_url = (!empty($errors['video-url'])) ? "form__input-section--error" : "";
    ...
    <div class="form__text-inputs-wrapper">
        <div class="form__text-inputs">
            <div class="adding-post__input-wrapper form__input-wrapper">
                ...
                <div
                    class="form__input-section <?= $validation_video_url ?>">
                    ...
                    <div class="form__error-text">
                        ...
                        <p class="form__error-desc"><?= $error_video_url ?></p>
                    </div>
                </div>
            </div>
        </div>
