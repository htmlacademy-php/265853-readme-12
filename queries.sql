...
-- -----------------------------------------------------
INSERT `posts` (`date_add`, `title`,`content_text`,`quote_author`,`img_url`,`video_url`,`link`,`number_views`,`user_id`,`type_id`)
...
INSERT `comments` (`date_add`, `content`, `user_id`, `post_id`)
...
INSERT `subscriptions` (`user_id`, `subscriber_id`)
VALUES (4, 1);
